...
> Important: Some developers have experienced an issue where they had clasp globally installed by still they got the `Clasp not installed` error message. They were able to solve the issue by simply installing clasp locally. Thanks to @gerboland and @barecool for bringing up this issue. 
